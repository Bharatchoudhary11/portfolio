    ...
    <main className="min-h-screen relative overflow-hidden">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-md border-b border-gray-200">
        <div className="max-w-6xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="text-xl font-bold text-gray-900">Bharat Choudhary</div>
      ...
      <section id="about" className="relative overflow-hidden pt-24 pb-16 px-6">
        ...
        <div className="absolute inset-0 pointer-events-none -z-10">
          ...
          <div className="absolute inset-0 opacity-5" style={{backgroundImage:"linear-gradient(rgba(0,0,0,0.06) 1px, transparent 1px), linear-gradient(90deg, rgba(0,0,0,0.06) 1px, transparent 1px)",backgroundSize:"50px 50px"}} />
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div className="space-y-6">
              <div className="bg-white p-6 rounded-lg border border-gray-200">
                ...
                <p className="text-gray-600">B.E. Electronics & Telecommunication</p>
                <p className="text-sm text-gray-500">Army Institute of Technology, Pune</p>
                <p className="text-sm text-gray-500">CGPA: 8.32</p>
              </div>
              <div className="bg-white p-6 rounded-lg border border-gray-200">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {projects.map((project, index) => (
              <div key={index} className="bg-white rounded-lg border border-gray-200 overflow-hidden hover:shadow-lg hover:scale-105 transition-all duration-300 backdrop-blur-sm">
      ...
      <section id="experience" className="relative overflow-hidden py-16 px-6">
        ...
        <div className="absolute inset-0 pointer-events-none -z-10">
          ...
          <div className="absolute inset-0 opacity-5" style={{backgroundImage:"linear-gradient(rgba(0,0,0,0.05) 1px, transparent 1px), linear-gradient(90deg, rgba(0,0,0,0.05) 1px, transparent 1px)",backgroundSize:"60px 60px"}} />
        </div>
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold text-gray-900 mb-12 text-center">Experience</h2>
          <div className="space-y-8">
            <div className="bg-white p-6 rounded-lg border border-gray-200 hover:shadow-lg hover:scale-105 transition-all duration-300 backdrop-blur-sm">
              <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                <div>
                  <h3 className="text-xl font-semibold text-gray-900">Software Development Engineer</h3>
                  <p className="text-gray-600">Ingenii Digitalization</p>
                </div>
                <span className="text-sm text-gray-500 mt-2 md:mt-0">June 2025 - Present</span>
              </div>
            ...
            <div className="bg-white p-6 rounded-lg border border-gray-200 hover:shadow-lg hover:scale-105 transition-all duration-300 backdrop-blur-sm">
              <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                <div>
                  ...
                  <p className="text-gray-600">Spring Money</p>
                </div>
                <span className="text-sm text-gray-500 mt-2 md:mt-0">Oct 2024 - April 2025</span>
              </div>
              <ul className="text-gray-600 space-y-2">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-white p-6 rounded-lg border border-gray-200">
              ...
              <p className="text-gray-600">1st runner-up in Auto visionX hackathon by Bosch</p>
            </div>
            <div className="bg-white p-6 rounded-lg border border-gray-200">
              <h3 className="font-semibold text-gray-900 mb-2">🎓 Scholarship Awardee</h3>
              <p className="text-gray-600">AWES ESSA Scholarship recipient</p>
            </div>
            <div className="bg-white p-6 rounded-lg border border-gray-200">
              <h3 className="font-semibold text-gray-900 mb-2">🎯 Event Organizer</h3>
              <p className="text-gray-600">Organized Technical Aakarti - college's biggest technical event</p>
            </div>
            <div className="bg-white p-6 rounded-lg border border-gray-200">
              <h3 className="font-semibold text-gray-900 mb-2">💻 Coding Excellence</h3>
              <p className="text-gray-600">Solved 1000+ problems across coding platforms</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="contact" className="relative overflow-hidden py-16 px-6">
        ...
        <div className="absolute inset-0 pointer-events-none -z-10">
          ...
          <div className="absolute inset-0 opacity-5" style={{backgroundImage:"linear-gradient(rgba(0,0,0,0.05) 1px, transparent 1px), linear-gradient(90deg, rgba(0,0,0,0.05) 1px, transparent 1px)",backgroundSize:"56px 56px"}} />
        </div>
        <div className="max-w-4xl mx-auto">
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-600">bharatchoudhary.work@gmail.com</span>
                </div>
                <div className="flex items-center space-x-3">
                  <svg className="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                  </svg>
                  <span className="text-gray-600">+91 9352674027</span>
                </div>
                <div className="flex items-center space-x-3">
                  <svg className="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
