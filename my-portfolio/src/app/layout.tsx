        ...
        <div className="fixed bottom-12 left-6 z-40 pointer-events-auto">
          <div className="flex flex-col gap-3 p-0">
            ...
            <a
              ...
              aria-label="GitHub"
              className="grid place-items-center w-10 h-10 rounded-full text-slate-700 dark:text-slate-200 hover:text-slate-900 dark:hover:text-white hover:bg-slate-100/80 dark:hover:bg-white/10 transition-colors"
            >
            ...
            {/* Decorative vertical line (~2cm) */}
            <div className="mx-auto mt-2 h-20 w-px bg-slate-400/60 dark:bg-slate-300/40 pointer-events-none" />
          </div>
        </div>
      </body>
    </html>
